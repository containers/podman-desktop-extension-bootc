...
<div
  class="flex flex-row items-center px-1 py-1 group bg-charcoal-700 border-[1px] border-charcoal-500 {$$props.class ||
    ''}"
  ...
  <input
    bind:this="{element}"
    on:input
    class="grow px-1 outline-0 bg-charcoal-700 text-sm placeholder:text-gray-700 overflow-hidden"
